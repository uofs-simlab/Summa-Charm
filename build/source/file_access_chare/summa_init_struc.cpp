...
void SummaInitStruc::getInitTolerance(double& rel_tol_temp_cas,
                                      ...
                                      double& abs_tol_aquifr, bool& def_tol, int& be_steps) {
  int def_tol_temp = 0;
  f_getInitTolerance(rel_tol_temp_cas, rel_tol_temp_veg, rel_tol_wat_veg, 
                     ...
                     abs_tol_wat_snow, abs_tol_matric, abs_tol_aquifr, def_tol, be_steps);
